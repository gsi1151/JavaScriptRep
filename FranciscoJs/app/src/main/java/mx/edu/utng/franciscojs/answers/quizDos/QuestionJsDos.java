...
public class QuestionJsDos extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        QuizJsDos db = new QuizJsDos(this);  // Mi clase de banco de preguntas
    ...
    public void getAnswer(String AnswerString) {
        if (currentQ.getANSWER().equals(AnswerString)) {
            ...
            score = score+2;
            helper.actualizarQuiz(score,2);
            helper.actualizarBloqueo(3);
        } else {

            // Si la actividad desafortunado comienzo y terminar el juego
            Intent intent = new Intent(QuestionJsDos.this, TemarioActivity.class);
        ...
        if (qid < 5) {
            ...
            Intent intent = new Intent(QuestionJsDos.this,
