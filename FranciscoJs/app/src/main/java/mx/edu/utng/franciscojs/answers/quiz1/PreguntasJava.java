...
public class PreguntasJava extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        QuizJava db = new QuizJava(this);  // Mi clase de banco de preguntas
    ...
    public void getAnswer(String AnswerString) {
        if (currentQ.getANSWER().equals(AnswerString)) {
            ...
            score = score+2;
            helper.actualizarQuiz(score,1);
            helper.actualizarBloqueo(2);
        } else {

            // Si la actividad desafortunado comienzo y terminar el juego
            Intent intent = new Intent(PreguntasJava.this,
