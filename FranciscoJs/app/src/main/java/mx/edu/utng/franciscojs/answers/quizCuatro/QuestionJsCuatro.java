...
public class QuestionJsCuatro extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        QuizJsCuatro db = new QuizJsCuatro(this);  // Mi clase de banco de preguntas
    ...
    public void getAnswer(String AnswerString) {
        if (currentQ.getANSWER().equals(AnswerString)) {
            ...
            score = score+2;
            helper.actualizarQuiz(score,4);
            helper.actualizarBloqueo(5);
        } else {

            // Si la actividad desafortunado comienzo y terminar el juego
            Intent intent = new Intent(QuestionJsCuatro.this,TemarioActivity.class);
        ...
        if (qid < 5) {
            ...
            Intent intent = new Intent(QuestionJsCuatro.this,
