...
public class PracticasCodigo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        QuizPracticas db = new QuizPracticas(this);  // Mi clase de banco de preguntas
    ...
    public void getAnswer(String AnswerString) {
        if (currentQ.getANSWER().equals(AnswerString)) {
            ...
            score = score+2;
            helper.actualizarQuiz(score,6);
        } else {

            // Si la actividad desafortunado comienzo y terminar el juego
            Intent intent = new Intent(PracticasCodigo.this,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.itm_mod_temario:
                startActivity(new Intent(PracticasCodigo.this, TemarioActivity.class));
                break;
        }
