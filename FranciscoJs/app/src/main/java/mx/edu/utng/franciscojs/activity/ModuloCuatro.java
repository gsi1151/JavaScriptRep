...
import mx.edu.utng.franciscojs.answers.quizCuatro.QuestionJsCuatro;
import mx.edu.utng.franciscojs.video.VideoActivityCuatro;


public class ModuloCuatro extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.modulo_cuatro);  //se saca porque sino se solapan
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_custionario:
                Intent i= new Intent(this, QuestionJsCuatro.class);
                startActivity(i);
                System.exit(0);
                break;
            case R.id.btn_video:
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.itm_mod_temario:
                startActivity(new Intent(ModuloCuatro.this, TemarioActivity.class));
                break;
        }
