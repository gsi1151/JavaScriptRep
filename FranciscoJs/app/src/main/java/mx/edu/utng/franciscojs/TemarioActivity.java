  ...
  //  private Button btnJuego;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.itm_utileria:
                startActivity(new Intent(TemarioActivity.this,Utilerias.class));
                break;

            case R.id.itm_acerca_de:
                startActivity(new Intent(TemarioActivity.this,AcercaDeScrollingActivity.class));
                break;
            case R.id.itm_practicas:
                startActivity(new Intent(TemarioActivity.this,PracticasCodigo.class));
                break;
            case R.id.itm_juego:
                startActivity(new Intent(TemarioActivity.this,JuegoNumero.class));
                break;

            case R.id.itm_ubicacion:
                startActivity(new Intent(TemarioActivity.this,MapsActivity.class));
                break;
        }
