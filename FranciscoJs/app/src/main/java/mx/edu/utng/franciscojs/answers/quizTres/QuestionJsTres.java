...
public class QuestionJsTres extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        QuizJsTres db = new QuizJsTres(this);  // Mi clase de banco de preguntas
    ...
    public void getAnswer(String AnswerString) {
        if (currentQ.getANSWER().equals(AnswerString)) {
            ...
            Intent intent = new Intent(QuestionJsTres.this,
