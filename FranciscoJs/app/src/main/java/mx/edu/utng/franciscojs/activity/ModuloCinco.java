...
import mx.edu.utng.franciscojs.answers.quizCinco.QuestionJsCin;
import mx.edu.utng.franciscojs.video.VideoActivityCinco;


public class ModuloCinco extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.modulo_cinco);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_custionario:
                Intent i= new Intent(this, QuestionJsCin.class);
                startActivity(i);
                System.exit(0);
                break;
            case R.id.btn_video:
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.itm_mod_temario:
                startActivity(new Intent(ModuloCinco.this, TemarioActivity.class));
                break;
        }
